...
ObjectStream.prototype.readField = function () {
	...
	if (id === 99) {
		return new Ref((this.stream.getUint8() << 16) | (this.stream.getUint8() << 8) | (this.stream.getUint8()));
	} else if (id <= 8) {
...
ObjectStream.prototype.readFixedFormat = function (id) {
	...
	case 31: //TranslucentColor
		var color = this.stream.getUint32();
		return new Color(color >> 22 & 0xFF, color >> 12 & 0xFF, color >> 2 & 0xFF, this.stream.getUint8());
	case 32: //Point
